...
const Header = ({ onOpenSidebar, isOpenSidebarDesktop, onSidebarDesktop }) => {
	const [user, setUser] = useState({ picture: 'https://i.imgur.com/VGEVWUy.png', correo: '', matricula: '' })
							...
							<List>
								<ListItem>
									...
									<ListItemText primary={<div>
										<Typography align='center'>{user.correo}</Typography>
										<Typography align='center'><b>{user.matricula}</b></Typography>
									</div>} />
								</ListItem>
							</List>
						</MenuItem>
